<?php
    ...
    */
    ...
    define('AGEWALLET_VERSION', '1.0.2');
        ...
        */
        private function initialize_updater() {
            ...
            try {
                ...
                $this->log_debug('Plugin Update Checker initialized.', ['slug' => 'agewallet']);

            } catch (Exception $e) {
                $this->log_debug('ERROR: Failed to initialize Plugin Update Checker.', ['exception' => $e->getMessage()]);
            }
        }
